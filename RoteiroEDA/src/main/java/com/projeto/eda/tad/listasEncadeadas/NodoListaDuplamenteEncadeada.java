...
public class NodoListaDuplamenteEncadeada<T extends Comparable<T>> extends NodoListaEncadeada<T>{
	...
	public <E extends Comparable<E>> NodoListaDuplamenteEncadeada(E elemento, ListaDuplamenteEncadeadaImpl.Nodo<E> anterior, ListaDuplamenteEncadeadaImpl.Nodo<E> proximo) {
